...
- Theatre's core (`@unseenco/theatre-core`) is released under the Apache License. Same
  goes for most packages in this repository.
- The studio (`@unseenco/theatre-studio`) is released under the AGPL 3.0 License. This is
  ...
  only includes `@unseenco/theatre-core`, so only the Apache License applies.
