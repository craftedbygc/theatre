...
import {prism, val, Atom} from '@unseenco/theatre-dataverse'
...
/**
 * Enables a few traces and debug points to help identify performance glitches in `@unseenco/theatre-react`.
